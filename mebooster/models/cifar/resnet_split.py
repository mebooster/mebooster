...
__all__ = [ 'resnet34', 'resnet50',
			...
			'wide_resnet28_10', 'wide_resnet40_10'] #'resnet18',
...
class ResNet(nn.Module):
	...
	def __init__(self, arch, block, layers, num_classes=1000, zero_init_residual=True,
		...
		if dataset == 'imagenet':
			...
			# for diff_training cifar, change the kernel_size=7 -> kernel_size=3 with stride=1
			self.layer0 = nn.Sequential(
...
def wide_resnet28_10(pretrained=False, progress=True, **kwargs):
	...
	return _resnet('wide_resnet28_10', BasicBlock, [4, 4, 4, 4],
						pretrained, progress, num_classes=10, norm_layer=norm.norm(model_args.norm_mode),
