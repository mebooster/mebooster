...
def main():
    ...
    score_opt = torch.optim.Adam(scorenet2.parameters(), lr=0.000005)
    ...
    scorenet2 = train_sliced_score2(dataload, scorenet2, score_opt, epochs, scheduler, x_test, scores_test2)
    torch.save(scorenet2.state_dict(), './model/scorenet2_step1.tar.pth')
