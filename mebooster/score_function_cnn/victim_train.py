...
def main():
    ...
    parser.add_argument('--model_arch', metavar='MODEL_ARCH', type=str, help='Model name', default='snet') #cifar_cnn
    # Optional arguments
    parser.add_argument('-o', '--out_path', metavar='PATH', type=str, help='Output path for model',
                        default=cfg.VICTIM_DIR)
    parser.add_argument('-d', '--device_id', metavar='D', type=int, help='Device id. -1 for CPU.', default=0)
    parser.add_argument('-b', '--batch-size', type=int, default=cfg.batch_size, metavar='N',
                        help='input batch size for diff_training (default: 64)')
    ...
    model_utils.train_model(model=model, ori_model=None, layer=None,
                            trainset=trainset, testset=testset, device=device, args=model_args, **params)
