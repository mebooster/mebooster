...
def over_initial_cnn(w1_dir1, w1_dir2,  w1_dir3, w1_dir4, w1_dir5, w1_dir6, w1_dir7, channel=3, over_factor=5):
    #over_factor
    d, m1 = w1_dir1.shape
    w1 = w1_dir1
    w2 = w1_dir2
    ...
    init_w1_6 = (w6 / torch.norm(w6, dim=1).view(-1, 1)) * math.sqrt(2. / d)  # mag4
    init_w1_7 = (w7 / torch.norm(w7, dim=1).view(-1, 1)) * math.sqrt(2. / d)  # mag5
    ...
    # m1 * d
    init_w1 = torch.vstack((init_w1_1.T, init_w1_2.T, init_w1_3.T, init_w1_4.T, init_w1_5.T, init_w1_6.T, init_w1_7.T)).view(m1*7, channel,
                                                                                    int(np.sqrt(d/channel)),
                                                                                    int(np.sqrt(d/channel)))[:int(m1*over_factor)] #init_w1_4.T, init_w1_5.T
    return init_w1
...
def main_runner(main_args):
    ...
    student = zoo.get_net(attack_model_name, test_modelfamily, pretrained=None,
                          num_classes=num_classes, over_factor=cfg.over_factor)#over_factor=cfg.over_factor,
    ...
    if ini == True:
        ...
        w1_dir1 = torch.load(f'./data_ini/fashionmnist/w1-0-{N_ini_query}.pt').to(device)
        w1_dir2 = torch.load(f'./data_ini/fashionmnist/w1-1-{N_ini_query}.pt').to(device)
        w1_dir3 = torch.load(f'./data_ini/fashionmnist/w1-2-{N_ini_query}.pt').to(device)
        w1_dir4 = torch.load(f'./data_ini/fashionmnist/w1-3-{N_ini_query}.pt').to(device)
        w1_dir5 = torch.load(f'./data_ini/fashionmnist/w1-4-{N_ini_query}.pt').to(device)
        w1_dir6 = torch.load(f'./data_ini/fashionmnist/w1-5-{N_ini_query}.pt').to(device)
        w1_dir7 = torch.load(f'./data_ini/fashionmnist/w1-6-{N_ini_query}.pt').to(device)
        init_w1 = over_initial_cnn(w1_dir1, w1_dir2, w1_dir3, w1_dir4, w1_dir5, w1_dir6, w1_dir7, channel=nc, over_factor=cfg.over_factor)
        student.conv1.weight = Parameter(init_w1)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--query_budget', type=float, default=50)
    parser.add_argument('--N_ini_query', type=int, default=80000)#3000 #80000 #2000
    ...
    cfg.attack_set = 'cifar10_dfme_ini'
    ...
    cfg.attack_set = 'cifar10_dfme_over'
    cfg.attack_model_arch = 'over_resnet18'
    main_args.ini = False
    cfg.over_factor = 5  # 3
    main_args.MAZE = False  # 4
    ...
    cfg.attack_set = 'cifar10_dfme_base'
    cfg.attack_model_arch = 'over_resnet18'
    main_args.ini = False
    cfg.over_factor = 1  # 3
    main_args.MAZE = False  # 4
    ...
    cfg.attack_set = 'cifar10_maze_ini'
    cfg.attack_model_arch = 'over_resnet18'
    main_args.ini = True
    cfg.over_factor = 5  # 3
    ...
    cfg.attack_set = 'cifar10_maze_over'
    cfg.attack_model_arch = 'over_resnet18'
    main_args.ini = False
    cfg.over_factor = 5  # 3
    main_args.MAZE = True  # 4
    ...
    cfg.attack_set = 'cifar10_maze_base'
    cfg.attack_model_arch = 'over_resnet18'
    main_args.ini = False
    cfg.over_factor = 1  # 3
    main_args.MAZE = True  # 4
