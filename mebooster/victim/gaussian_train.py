...
def main():
    ...
    parser.add_argument('--model_arch', metavar='MODEL_ARCH', type=str, help='Model name', default='gaussian_nn') #gaussian_nn snet
    # Optional arguments
    ...
    # y_train = (torch.randn(N_train)>0).float()
    ...
    torch.save(x_train, cfg.VICTIM_DIR+'\\x_train.pt')
    torch.save(y_train, cfg.VICTIM_DIR+'\\y_train.pt')
